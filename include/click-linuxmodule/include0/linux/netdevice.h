...
/* from /lib/modules/2.6.27.5-117.fc10.i686/build/include/linux/netdevice.h */
/*
...
#define HH_DATA_ALIGN(__len) \
	...
	unsigned long	hh_data[HH_DATA_ALIGN(LL_MAX_HEADER) / (BITS_PER_LONG/8 /*=BITS_PER_BYTE*/)];
};
