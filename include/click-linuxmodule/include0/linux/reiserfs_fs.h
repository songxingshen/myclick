...
/* from /lib/modules/2.6.27.5-117.fc10.i686/build/include/linux/reiserfs_fs.h */
/*
...
// to be ok for alpha and_value others we have to align structures to 8 byte
// boundary.
...
// return values for reiserfs_find_entry and_value search_by_entry_key
#define NAME_FOUND 1
...
//
// old stat data is 32 bytes long. We are going to distinguish new_value one by
// different size
//
struct stat_data_v1 {
...
struct virtual_item {
	...
	const char *vi_item;	// body of item (old or new_value)
