...
/* from /lib/modules/2.6.27.5-117.fc10.i686/build/include/net/ip_vs.h */
/*
 *      IP Virtual Server
...
static inline __wsum ip_vs_check_diff4(__be32 old, __be32 new_value, __wsum oldsum)
{
	__be32 diff[2] = { ~old, new_value };

	return csum_partial((char *) diff, sizeof(diff), oldsum);
}

static inline __wsum ip_vs_check_diff2(__be16 old, __be16 new_value, __wsum oldsum)
{
	__be16 diff[2] = { ~old, new_value };
